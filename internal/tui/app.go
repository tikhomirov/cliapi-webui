...
func NewApp(port int, secretKey string, hook *LogHook) App {
	...
	app := App{
		...
		providers:     newProvidersTabModel(client),
		client:        client,
		initialized: [8]bool{
			tabDashboard: true,
			tabLogs:      true,
...
func (a App) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case tea.WindowSizeMsg:
		...
		a.providers.SetSize(contentW, contentH)
		return a, nil
...
func (a App) View() string {
	...
	case tabProviders:
		sb.WriteString(a.providers.View())
	}
