...
// Tab names
// ──────────────────────────────────────────
var zhTabNames = []string{"仪表盘", "配置", "认证文件", "API 密钥", "OAuth", "使用统计", "日志", "提供者"}
var enTabNames = []string{"Dashboard", "Config", "Auth Files", "API Keys", "OAuth", "Usage", "Logs", "Providers"}
...
var zhStrings = map[string]string{
	...
	// ── Providers ──
	"providers_title":                   "🔌 提供者",
	"providers_help":                    " [r] 刷新 • [/] 过滤模型 • [↑↓] 滚动",
	"providers_filter_hint":             "  [/] 过滤模型名称",
	"providers_filter_placeholder":      "输入模型名称...",
	"providers_no_data":                 "  暂无提供者数据",
	"providers_models":                  "个模型",
	"providers_summary":                 "  共 %d 个模型 / %d 个提供者",
	"providers_summary_filtered":        "  显示 %d 个模型 / %d 个提供者 (过滤: %s)",
	"providers_all_models":              "全部可用模型",
	"providers_status_ok":               "已连接",
	"providers_status_oauth_active":     "OAuth 已激活",
	"providers_status_oauth_inactive":   "OAuth 未激活",
	"providers_status_models_via_proxy": "通过代理可用",
	"providers_status_timeout":          "连接超时",
	"providers_status_error":            "连接错误",
	"providers_status_no_models":        "无模型端点",
}
...
var enStrings = map[string]string{
	...
	"providers_help":                    " [r] Refresh • [/] Filter models • [↑↓] Scroll",
	"providers_filter_hint":             "  [/] Filter models by name",
	"providers_filter_placeholder":      "Type to filter models...",
	"providers_no_data":                 "  No provider data available",
	"providers_models":                  "models",
	"providers_summary":                 "  Total %d models across %d providers",
	"providers_summary_filtered":        "  Showing %d models across %d providers (filter: %s)",
	"providers_all_models":              "All Available Models",
	"providers_status_ok":               "Connected",
	"providers_status_oauth_active":     "OAuth Active",
	"providers_status_oauth_inactive":   "OAuth Inactive",
	"providers_status_models_via_proxy": "Available via Proxy",
	"providers_status_timeout":          "Connection Timeout",
	"providers_status_error":            "Connection Error",
	"providers_status_no_models":        "No Models Endpoint",
}
