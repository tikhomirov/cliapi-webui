...
// OpenCodeConfig configures the OpenCode CLI executor.
type OpenCodeConfig struct {
	// BinPath is the path to the opencode binary (default: "opencode").
	BinPath string `yaml:"bin-path" json:"bin-path"`
}
