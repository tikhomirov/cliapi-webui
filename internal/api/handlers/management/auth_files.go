...
func isWebUIRequest(c *gin.Context) bool {
	// Check for explicit is_webui query parameter
	...
	// Also detect web panel requests via Origin or Referer headers
	origin := c.GetHeader("Origin")
	referer := c.GetHeader("Referer")
	if strings.Contains(origin, "127.0.0.1:3001") || strings.Contains(origin, "localhost:3001") ||
		strings.Contains(referer, "127.0.0.1:3001") || strings.Contains(referer, "localhost:3001") {
		return true
	}
